/**
 * NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech) (3.2.2).
...
public interface JobsApi {
    ...
    @ApiOperation(
            value = "",
            nickname = "createJob",
            notes = "Creates a new Job in the repository ",
            response = Job.class,
            tags = {})
    @ApiResponses(
            value = {
    ...
    default ResponseEntity<Job> createJob(
            @ApiParam(value = "Job to add to the repository ", required = true) @Valid @RequestBody
                    Job job) {
        getRequest()
                .ifPresent(
                        request -> {
                            for (MediaType mediaType :
                                ...
                                if (mediaType.isCompatibleWith(
                                    ...
                                    ApiUtil.setExampleResponse(
                                            request,
                                            "application/json",
                                            "{  \"useCase\" : \"useCase\",  \"processingTool\" : \"processingTool\",  \"created\" : \"2000-01-23T04:56:07.000+00:00\",  \"areaOfInterest\" : {    \"extent\" : [ -151.17018, -151.17018, -151.17018, -151.17018 ]  },  \"inputs\" : [ null, null ],  \"name\" : \"name\",  \"description\" : \"description\",  \"timeInterval\" : \"timeInterval\",  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"}");
                                    break;
                                }
                            }
                        });
    ...
    default ResponseEntity<Void> deleteJob(
            @ApiParam(value = "ID of job to delete ", required = true) @PathVariable("id")
                    String id) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }
    ...
    default ResponseEntity<Job> retrieveJobById(
            @ApiParam(value = "ID of job to retrieve ", required = true) @PathVariable("id")
                    String id) {
        getRequest()
                .ifPresent(
                        request -> {
    ...
    @ApiOperation(
            value = "",
            nickname = "retrieveJobs",
            notes = "Returns a paginated list of jobs ",
            response = PaginatedJobResponse.class,
            tags = {})
    @ApiResponses(
            value = {
                @ApiResponse(
